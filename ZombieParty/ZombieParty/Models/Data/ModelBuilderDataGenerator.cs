    ...
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<Weapon>().HasData(
                ...
                new Weapon() { WeaponId = 3, Name = "Excaliburg", Description = "La espada de los mil caidos", Force = 1000, Image = "https://img.magnific.com/premium-psd/excalibur-sword-stone-isolated-transparent-background_879541-1688.jpg", Price = 550, Qty = 6, QtyBought = 1, CreatedDate = new DateTime(1000, 10, 10)}
            );
            #endregion
        }
    }
